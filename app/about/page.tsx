            ...
            <div>
              ...
              <div className="space-y-8">
                <p className="text-lg text-muted-foreground leading-relaxed">
                  ...
                  respecting the natural environment. Our practice focuses on
                  creating spaces that are both functional and poetic.
                </p>

                <p className="text-lg text-muted-foreground leading-relaxed">
                  Founded in 2015, our studio has completed over 200 projects
                  across residential, commercial, and cultural sectors. Each
                  project begins with careful listening and ends with thoughtful
                  execution.
                </p>
              </div>
            </div>
